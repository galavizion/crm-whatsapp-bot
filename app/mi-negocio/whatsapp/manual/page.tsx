...
export default async function WhatsAppGuiaManualPage() {
    ...
    <div className="space-y-6 pb-10">
      ...
      <Step numero={1} titulo="Crea tu cuenta de Meta Business Manager">
        ...
        <ol className="text-sm text-slate-700 space-y-2 mb-5 list-decimal pl-5">
          <li>Ve a <A href="https://business.facebook.com">business.facebook.com</A></li>
      ...
      <Step numero={2} titulo="Crea una App en Meta for Developers">
        ...
        <ol className="text-sm text-slate-700 space-y-2 mb-5 list-decimal pl-5">
          <li>Ve a <A href="https://developers.facebook.com/apps">developers.facebook.com/apps</A></li>
          <li>Haz clic en <strong>Crear app</strong></li>
          <li>Selecciona el tipo <strong>"Empresa"</strong> (Business)</li>
          <li>Escribe el nombre de tu app — puede ser el nombre de tu negocio</li>
          <li>En <em>Cuenta de Business Manager</em>, selecciona la cuenta que acabas de crear</li>
          <li>Haz clic en <strong>Crear app</strong></li>
        </ol>
      ...
      <Step numero={3} titulo="Agrega el producto WhatsApp a tu app">
        ...
        <ol className="text-sm text-slate-700 space-y-2 mb-5 list-decimal pl-5">
          ...
          <li>Se creará automáticamente una Cuenta de WhatsApp Business (WABA) vinculada a tu Business Manager</li>
      ...
      <Step numero={4} titulo="Agrega y verifica tu número de teléfono">
        ...
        <ol className="text-sm text-slate-700 space-y-2 mb-5 list-decimal pl-5">
          <li>En el menú de tu app, ve a <strong>WhatsApp › Configuración</strong></li>
          ...
          <li>Meta te enviará un código de verificación por SMS o llamada — ingrésalo para confirmar</li>
        </ol>
        <Nota>
          Si tu número ya está en WhatsApp Business app, debes ir a{" "}
          <strong>Configuración › Cuenta › Eliminar mi cuenta</strong>{" "}
        ...
        <ol className="text-sm text-slate-700 space-y-2 mb-5 list-decimal pl-5">
          <li>
            ...
            <A href="https://business.facebook.com/settings/system-users">
              Meta Business Manager › Configuración › Usuarios del sistema
            </A>
          </li>
          <li>Haz clic en <strong>Agregar</strong></li>
          <li>Dale un nombre (ej: <em>Prospekto Bot</em>) y rol <strong>Administrador</strong></li>
          <li>Haz clic en <strong>Crear usuario del sistema</strong></li>
          <li>
            Luego clic en <strong>Agregar activos</strong> → selecciona{" "}
            <strong>Apps</strong> → elige tu app → activa <strong>Control total</strong>
          </li>
          <li>También agrega la <strong>Cuenta de WhatsApp Business</strong> con <strong>Control total</strong></li>
          <li>
            Haz clic en <strong>Generar token</strong>, selecciona tu app y activa los permisos:
            <ul className="list-disc pl-5 mt-1 space-y-1">
              <li><code className="bg-slate-100 px-1.5 py-0.5 rounded text-xs">whatsapp_business_messaging</code></li>
              <li><code className="bg-slate-100 px-1.5 py-0.5 rounded text-xs">whatsapp_business_management</code></li>
            </ul>
          </li>
          <li>Copia el token generado — <strong>solo aparece una vez</strong>, guárdalo de inmediato</li>
        </ol>
      ...
      <Step numero={6} titulo="Obtén el Phone Number ID">
        ...
        <ol className="text-sm text-slate-700 space-y-2 mb-5 list-decimal pl-5">
          <li>En el panel de tu app ve a <strong>WhatsApp › Primeros pasos</strong> (o <em>Getting started</em>)</li>
          <li>
            Verás el campo <strong>Phone Number ID</strong> — es un número largo, ej:{" "}
            <code className="bg-slate-100 px-1.5 py-0.5 rounded text-xs">101474725172793</code>
          </li>
          <li>Cópialo</li>
        </ol>
      ...
      <Step numero={7} titulo="Envíanos los datos para activar el bot" highlight>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3 mb-5">
          ...
          <DatoItem label="Número de teléfono" ejemplo="+52 818 123 4567" />
        </div>
        <a
...
function Step({
  ...
  return (
    <div className={`rounded-2xl border shadow-sm p-5 ${highlight ? "bg-purple-50 border-purple-200" : "bg-white border-slate-200"}`}>
      <div className="flex items-center gap-3 mb-4">
        <span className={`w-8 h-8 rounded-xl flex items-center justify-center text-sm font-bold shrink-0 ${highlight ? "bg-[linear-gradient(135deg,#8c7ac6_0%,#c84f92_100%)] text-white" : "bg-slate-100 text-slate-700"}`}>
          {numero}
        </span>
...
function DatoItem({ label, ejemplo }: { label: string; ejemplo: string }) {
  return (
    <div className="flex flex-col gap-0.5">
      ...
      <code className="text-xs text-slate-500 bg-white border border-slate-200 px-2 py-1 rounded-lg">{ejemplo}</code>
    </div>
  );
}
