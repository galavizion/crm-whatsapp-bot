      ...
      <nav className="nav-glass sticky top-0 z-50 w-full" style={{ position: "relative" }}>
        <div className="flex items-center justify-between px-6 mx-auto" style={{ maxWidth: 1100, height: 64 }}>
          ...
          <div className="hidden sm:flex items-center gap-7">
            ...
            <a href="/contacto" style={{ fontSize: 14, color: "#6b7280", textDecoration: "none", fontWeight: 500, transition: "color 0.2s" }}
              onMouseEnter={e => (e.currentTarget.style.color = "#1a2035")}
              onMouseLeave={e => (e.currentTarget.style.color = "#6b7280")}>
              Contacto
            </a>
      ...
      <section id="features" style={{ padding: "72px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 }}>
            {[
              { icon: "💬", title: "Bot conversacional con IA", desc: "Responde en lenguaje natural con el tono de tu negocio.Tu eliges que y como responder, sin configuración compleja." },
