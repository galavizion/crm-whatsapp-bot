      ...
      if (contacto) {
        ...
        await supabase
          ...
          .update({
            ...
            nombre: (igMemory.nombre && igMemory.nombre !== "Desconocido") ? igMemory.nombre : (contacto.nombre || null),
      ...
      if (fbContacto) {
        ...
        await supabase
          ...
          .update({
            ...
            nombre: (fbMemory.nombre && fbMemory.nombre !== "Desconocido") ? fbMemory.nombre : (fbContacto.nombre || null),
    ...
    if (contacto) {
      ...
      await supabase
        ...
        .update({
          ...
          nombre: profileName || ((memory.nombre && memory.nombre !== "Desconocido") ? memory.nombre : null) || contacto.nombre || null,
